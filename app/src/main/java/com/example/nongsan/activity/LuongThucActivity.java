...
import com.example.nongsan.adapter.LuongThucAdapter;
...
public class LuongThucActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luong_thuc);
                ...
                sanPhamMoiModel -> {
                    if(sanPhamMoiModel.isSuccess()){
                        if(adapterLt == null){
                            ...
                            adapterLt = new LuongThucAdapter(getApplicationContext(), sanPhamMoiList);
